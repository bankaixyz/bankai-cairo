...
cairo-compile --cairo_path=cairo/packages/garaga_zero/src:cairo/packages/mmr_header_accumulator "$PROGRAM_PATH" --output "cairo/build/${OUTPUT_NAME}.json" --no_debug_info --proof_mode
