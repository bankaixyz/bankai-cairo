...
// from cairo.bankai_new.light_clients.ethereum.utils.domain import Domain
// from cairo.bankai_new.light_clients.ethereum.config.config import get_fork_data
