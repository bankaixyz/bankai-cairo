...
func compute_output_hash{range_check_ptr, poseidon_ptr: PoseidonBuiltin*}(
    ...
    tempvar output_elements = cast(
        new (
            ...
            previous_output.beacon.mmr_root_sha.low,
            previous_output.beacon.mmr_root_sha.high,
            ...
            previous_output.execution.mmr_root_sha.low,
            previous_output.execution.mmr_root_sha.high,
