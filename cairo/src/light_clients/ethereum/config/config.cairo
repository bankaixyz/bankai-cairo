...
from cairo.src.light_clients.ethereum.config.mainnet import (
    get_config_mainnet,
    get_fork_data_mainnet,
    get_fork_domain_mainnet,
    get_fork_schedule_mainnet,
)
from cairo.src.light_clients.ethereum.config.sepolia import (
    get_config_sepolia,
    get_fork_data_sepolia,
    get_fork_domain_sepolia,
    get_fork_schedule_sepolia,
)
from cairo.src.light_clients.ethereum.config.types import EthereumConfig, Networks
...
func get_genesis_validator_root(network_id: felt) -> Uint256 {
    if (network_id == Networks.MAINNET) {
        return (
            Uint256(low=0x54bfe9f06bf33ff6cf5ad27f511bfe95, high=0x4b363db94e286120d76eb905340fdd4e)
        );
    } else {
        return (
