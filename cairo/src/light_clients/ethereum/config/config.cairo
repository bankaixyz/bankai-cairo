...
from cairo.src.light_clients.ethereum.config.mainnet import get_config_mainnet, get_fork_data_mainnet, get_fork_domain_mainnet, get_fork_schedule_mainnet
from cairo.src.light_clients.ethereum.config.sepolia import get_config_sepolia, get_fork_data_sepolia, get_fork_domain_sepolia, get_fork_schedule_sepolia
