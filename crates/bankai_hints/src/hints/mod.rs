...
pub fn get_hints() -> HashMap<String, HintImpl> {
    ...
    hints.insert(os::HINT_WRITE_INIT_DATA.into(), os::write_init_data);
    hints.insert(os::HINT_PREVIOUS_BLOCK.into(), os::write_previous_block);
    hints.insert(
        os::HINT_WRITE_MOCK_RECURSION_INPUTS.into(),
        os::write_mock_recursion_inputs,
    );
    hints.insert(os::HINT_VERIFY_BLOCK_RESULT.into(), os::verify_block_result);
    hints
}
